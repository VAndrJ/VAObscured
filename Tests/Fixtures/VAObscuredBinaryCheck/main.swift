...
print(#Obscured("VAObscured_probe_subtraction_794DB520", encoding: .xor(keyShift: .substraction)))
...
print(#Obscured("VAObscured_probe_multi_sub_A1BC8536", encoding: .xor(keysCount: 4, keyShift: .substraction)))
