...
assert(string == #Obscured("String", encoding: .xor(keyShift: .subtraction)))
...
assert(string == #Obscured("String", encoding: .xor(keysCount: 1, keyShift: .subtraction)))
...
assert(string == #Obscured("String", encoding: .xor(keysCount: 10, keyShift: .subtraction)))
